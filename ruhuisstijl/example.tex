...
\begin{frame}
    ...
    {\tiny Afbeeldingen en teksten mogen nooit over de onderste lijn en het logo geplaatst worden.}
\end{frame}
...
\begin{frame}
    ...
    Zwart: RGB 0/0/0 \\
    Wit: RGB 250/250/250 \\
    \textcolor{ruhuisstijlrood}{Rood: RGB 190/49/26 (RU huisstijl rood)} \\
...
\begin{frame}
    ...
    \begin{block}{}
        ...
        \begin{itemize}
            \item Dia's > Indelingen > \textcolor{ruhuisstijlrood}{RU Tekstpagina's}
            \item Dia's > Indelingen > \textcolor{ruhuisstijlrood}{RU Titelpagina's}
        \end{itemize}
    \end{block}
    \vspace{1em}

    {\tiny Hierna volgen enkele voorbeeldpagina's, de paginatitels zijn gelijk aan de naam van het sjabloon}
\end{frame}
...
%        \rowcolor{ruhuisstijlrood}\rowfont{\color{white}}
