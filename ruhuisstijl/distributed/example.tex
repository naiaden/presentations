...
%% single-file version of the template. The full (multiple-file)
%% version is always up-to-date, so try that version first if you
...
\documentclass[department=ds, notes={hide notes}, slidesperpage=4, handout, official=true]{beamerruhuisstijl}
