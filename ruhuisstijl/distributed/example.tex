...
%% 25 November 2014: DS, iCIS, IS, MBSD templates added

\documentclass[department=ds, notes={show notes}, slidesperpage=4, handout, official=true]{beamerruhuisstijl}
...
%% department: clst, cls, hlcs, kaski, ptrs, imr, ster, ds, is, mbsd, icis (default = RU)
...
\begin{frame}{Distribution and Availability}
    ...
    \begin{block}{Distribution}
    	The code is currently licensed as \href{https://creativecommons.org/licenses/by/4.0/}{CC BY 4.0}. The Radboud University holds the right to the background images and to the texts on the slides \cpagerefrange{sl:gvwa,sl:vvet}.
    \end{block}
\end{frame}
\note{
...
\end{frame}
\note{
	Tables are actually quite tricky. By default the rows are alternately coloured. I suggest you follow the rules as described by booktabs. One of their main points is that you shouldn't use vertical lines.
