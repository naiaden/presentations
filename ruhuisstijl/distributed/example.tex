...
\documentclass[department=kaski, notes={hide notes}, slidesperpage=4, handout, official=true]{beamerruhuisstijl}
%% The class takes the following optional arguments:
%% notes: {show notes}, {hide notes}, {show only notes}
%% official: true, false
%% department: clst, cls, hlcs, kaski, ptrs, imr, ster (default = RU)
%% handout
